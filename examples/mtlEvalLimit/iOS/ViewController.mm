...
-(NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component {
    if(pickerView == _modelPickerView) {
        ...
        switch((ShadingMode)row) {
            case kShadingUV: return @"UV";
            case kShadingVARYING: return @"Varying";
            case kShadingNORMAL: return @"Normal";
            case kShadingSHADE: return @"Shaded";
            case kShadingFACEVARYING: return @"Face-varying";
            case kShadingMEAN_CURVATURE: return @"Mean Curvature";
        }
    }
    return @"";
}
